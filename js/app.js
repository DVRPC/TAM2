...
$(function () {
  ...
  DrawComplete = L.Control.extend({
    ...
    onAdd: function () {
      ...
      .on(btn, 'click', function () {
        ...
        modal.find('.property-road-segment-condition, .property-road-segment-federalaid, .property-road-segment-act32, .property-road-segment-mcd, .property-road-segment-owner, .property-road-segment-cartway, .property-road-segment-road, .property-road-segment-liquidfuels, .property-road-segment-private').text('').closest('.form-group').hide()
  ...
  }).fitBounds([[40.1675185812983, -75.7309824107495], [40.4007338308102, -75.4971735164997]]).on('moveend', function () {updateEncodedURL(map, [roads, editable])}).on('draw:created', function (e) {
  ...
  }).on('layeradd', function () {updateEncodedURL(map, [roads, editable])}).on('click', function (e) {
    var modal = $('#modal-repair')
  ...
  $.getJSON('data/local_roads.geojson', function (d) {
    roads.addData(d)
  })

  $.getJSON('data/mcd.geojson', function (d) {
    labels.addData(d)
  })
